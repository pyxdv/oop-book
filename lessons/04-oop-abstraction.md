...
#### Lesson Learning Outcomes (ผลลัพธ์การเรียนรู้ระดับบทเรียน: LLO)

หลังจากเรียนจบบทนี้ นักศึกษาจะสามารถ:

1. **อธิบาย** ความหมายของ Object-Oriented Programming (OOP) และองค์ประกอบพื้นฐาน ได้แก่ class, object, attribute และ method ได้อย่างถูกต้อง
2. **ประยุกต์ใช้** แนวคิด **Abstraction** โดยสามารถ **เลือก** คุณสมบัติ (attributes) และพฤติกรรม (methods) ที่จำเป็นของปัญหา/สถานการณ์ที่กำหนด และ **ตัดทอน** รายละเอียดที่ไม่เกี่ยวข้อง เพื่อสร้างแบบจำลองเชิงนามธรรมได้อย่างเหมาะสม&#x20;
3. **กำหนด** ความรับผิดชอบ (Responsibilities) ของ Class จากโจทย์ที่กำหนดได้อย่างชัดเจน และสอดคล้องกับบทบาทของคลาสนั้นในระบบ &#x20;
4. **เขียนโปรแกรมภาษา Java** เพื่อสร้าง Class และสร้าง Object ขั้นพื้นฐานได้ โดยกำหนด fields และ methods และสามารถเรียกใช้งาน object ผ่าน method call ได้อย่างถูกต้อง
5. **ออกแบบ** Class ให้สอดคล้องกับหลัก **Single Responsibility Principle (SRP)** โดยสามารถแยก Class ที่มีหน้าที่มากกว่าหนึ่งความรับผิดชอบออกเป็น Class ที่มีหน้าที่เฉพาะเจาะจงได้อย่างเหมาะสม
...
**ตัวอย่างที่ไม่ดี - คลาสมีหลายความรับผิดชอบที่ไม่เกี่ยวข้องกัน:**
...
**ตัวอย่างที่ดี - แยกความรับผิดชอบชัดเจน:**
