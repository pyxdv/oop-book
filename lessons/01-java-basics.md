...
1. บอกโครงสร้างพื้นฐานของโปรแกรม Java ได้
2. ประกาศและใช้งาน Variables และ Data Types ต่างๆ ได้
3. รับ Input จากผู้ใช้และแสดง Output ได้
4. ใช้ Operators ต่างๆ (Arithmetic, Relational, Logical) ได้อย่างถูกต้อง
5. เขียนโปรแกรม Java พื้นฐานที่ Compile และ Run ได้ **(CLO1)**
